...
import { XMarkIcon, PlusIcon, HandThumbUpIcon, SpeakerXMarkIcon, SpeakerWaveIcon } from "@heroicons/react/24/outline";
            ...
            <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
                <div className="space-y-6 text-lg">
                    ...
                    <div className="flex items-center space-x-2 text-sm">
                        ...
                        <div className="flex h-4 items-center justify-center rounded border border-color-white/40 px-1.5 text-xs">HD</div>
                    </div>
                </div>
